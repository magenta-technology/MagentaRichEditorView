...
zss_editor.setContentEditable = function(contenteditable) {
    var editor = $('#zss_editor_content');
    editor.contenteditable = contenteditable
}

zss_editor.contentEditable = function() {
    return $('#zss_editor_content').isContentEditable
}

zss_editor.setEditorBackgoundColor = function(color) {
    document.getElementsByTagName('body')[0].style.backgroundColor = color;
}

zss_editor.setFontSize = function(size) {
    document.getElementById('zss_editor_content').style.fontSize = size;
}

zss_editor.setBaseTextColor = function(color) {
    var editor = $('#zss_editor_content');
    document.getElementById('zss_editor_content').style.color = color;
}

zss_editor.setLineHeight = function(height) {
    document.getElementById('zss_editor_content').style.lineHeight = height;
}
//end
